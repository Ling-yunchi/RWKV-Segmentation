...
from model.components import DropPath, PatchEmbed, resize_pos_embed
from model.utils import get_root_logger, load_model_checkpoint
...
class VRWKV(nn.Module):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 with_cp=False, ):
        if not isinstance(pretrained, (str, type(None))):
    ...
    def init_weights(self):
        ...
        if self.pretrained is None:
            ...
            load_model_checkpoint(self, self.pretrained)
